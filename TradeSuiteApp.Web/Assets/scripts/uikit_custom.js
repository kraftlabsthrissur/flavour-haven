...
(function(UI) {
    ...
    UI.modal.confirm = function(content, onconfirm, oncancel) {
        ...
        var modal = UI.modal.dialog(([
            '<div class="uk-margin uk-modal-content">'+String(content)+'<br/></div>',
            '<div class="uk-modal-footer uk-text-right"><button class="uk-button md-btn-primary js-modal-confirm">' + options.labels.Ok + '</button> <button class="uk-button  uk-button-default js-modal-confirm-cancel">' + options.labels.Cancel + '</button></div>'
        ]).join(""), options);
        ...
        modal.on('show.uk.modal', function(){
            setTimeout(function(){
                modal.element.find('.js-modal-confirm-cancel').focus();
            }, 50);
        });
...
(function(UI) {
    ...
    UI.component('tab', {
        ...
        init: function() {
            ...
            this.element.prepend(this.responsivetab);
...
(function(addon) {
    ...
    UI.component('autocomplete', {
        ...
        render: function(data) {
            ...
            // this.dropdown.empty(); // moved to line 4426
    ...
    UI.component('lightbox', {
        ...
        fitSize: function() {
            ...
            if (this.siblings.length > 1) {
                ...
                content = [
                    content,
                    '<a  class="uk-slidenav uk-slidenav-contrast uk-slidenav-previous uk-hidden-touch" data-lightbox-previous></a>',
                    '<a  class="uk-slidenav uk-slidenav-contrast uk-slidenav-next uk-hidden-touch" data-lightbox-next></a>'
                ].join('');
            }
...
(function(addon) {
    ...
    UI.component('timepicker', {
        ...
        init: function() {
            ...
            var $this  = this, times = getTimeRange(this.options.start, this.options.end,this.options.step), container;
    ...
    function getTimeRange(start, end,step) {
        ...
        for (i = start, h=''; i<end; i++) {
            ...
            if(step==15){
                times['24h'].push({ value: (h + ':15') });
            }
            times['24h'].push({ value: (h + ':30') });
            if (step == 15) {
                times['24h'].push({ value: (h + ':45') });
            }
            ...
            if (i === 0) {
                ...
                if (step == 15) {
                    times['12h'].push({ value: (h + ':15 AM') });
                }
                times['12h'].push({ value: (h + ':30 AM') });
                if (step == 15) {
                    times['12h'].push({ value: (h + ':45 AM') });
                }
            }
            ...
            if (i >= 12) {
                ...
                if (step == 15)
                {
                    times['12h'].push({ value: (h + ':15 PM') });
                }
                times['12h'].push({ value: (h + ':30 PM') });
                if (step == 15) {
                    times['12h'].push({ value: (h + ':45 PM') });
                }
            }
        }
                ...
                .on('show.uk.modal', '.uk-modal-dialog-replace', function () {
                    ...
                    setTimeout(function () {
                        ...
                        if (dialogReplace.find('.uk-button').length) {
                            dialogReplace.find('.uk-button').toggleClass('uk-button md-btn ');
                        }
