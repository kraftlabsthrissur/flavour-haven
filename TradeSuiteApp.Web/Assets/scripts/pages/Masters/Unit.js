...
unit = {
    unit_list: function () {
        ...
        if ($unit_list.length) {
            ...
            $('#unit-list tbody tr').on('click', function () {
                ...
                window.location = '/Masters/Unit/Details/' + Id;
            });
            altair_md.inputs();
    ...
    bind_events: function () {
        $(".btnUpdate").on('click', unit.update);
        $(".btnSave").on('click', unit.save_confirm);
    },
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.Status == "success") {
                    ...
                    setTimeout(function () {
                       window.location = "/Masters/Unit/Index";
                    }, 1000);
                } else {
