LogicCode = {
    ...
    list: function () {
        ...
        if ($list.length) {
            ...
            var url = "/Masters/LogicCode/GetLogicCodeList"
            ...
            var list_table = $list.dataTable({
                ...
                "drawCallback": function () {
                    $list.find('tbody td:not(.action)').on('click', function () {
                        ...
                        app.load_content("/Masters/LogicCode/Details/" + Id);
                    });
                },
            });
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.Status == "success") {
                    ...
                    setTimeout(function () {
                        window.location = "/Masters/LogicCode/Index";
                    }, 1000);
                } else {
