...
///This PurchaseInvoice.js For Janaushadhi-Created By neethu
...
purchase_invoice = {
    ...
    get_grn_autocomplete : function (release) {
        $.ajax({
            url: '/Purchase/GRN/GetUnProcessedGRNAutoCompleteV4',
            data: {
    ...
    get_alopathy_grn : function () {
        ...
        var Hint;
        $.ajax({
            url: '/Purchase/GRN/GetUnProcessedGRNV4',
            data: {
            ...
            var list_table = $list.dataTable({
                ...
                "drawCallback": function () {
                    $list.find('tbody td:not(.action)').on('click', function () {
                        ...
                        app.load_content("/Purchase/PurchaseInvoice/GenerateDetailsV4/" + Id);
                    });
                },
            });
