...
CounterSales.bind_events = function () {
    ...
    $("body").on("keyup change", "#counter-sales-items-list .Qty", self.check_stock);
...
CounterSales.add_items_to_grid = function (items) {
    ...
    $.each(items, function (i, item) {
        ...
        tr += '<tr>'
                ...
                + ' <td >' + item.BatchNo + '</d>'
                + ' <td class="Unit">' + item.Unit + '</td>'
                + ' <td ><input type="text" class="md-input Rate mask-sales-currency" value="' + item.MRP + '" readonly="readonly" /></td>'
