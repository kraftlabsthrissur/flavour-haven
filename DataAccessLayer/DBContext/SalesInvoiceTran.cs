...
namespace DataAccessLayer.DBContext
{
    ...
    public partial class SalesInvoiceTran
    {
        ...
        public Nullable<decimal> ReturnOfferQtyMet { get; set; }
        public Nullable<decimal> COGS { get; set; }
        public string Remarks { get; set; }
        public Nullable<int> MedicineIssueID { get; set; }
        public Nullable<int> MedicineIssueTransID { get; set; }
        ...
        public Nullable<bool> PrintWithItemCode { get; set; }
